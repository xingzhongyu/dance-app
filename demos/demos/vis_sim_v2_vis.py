...
def plot_pre_normalized_radar_v3(df, highlight_dataset_name, tissue, query_dataset,
                                 # 控制区域
    ...
    for index, row in df.iterrows():
        ...
        ax.plot(angles, values, 
                color=highlight_color if is_highlight else other_color, 
                linewidth=highlight_linewidth if is_highlight else other_linewidth, 
    ...
    if query_dataset is not None:
        img_path=f"sim_imgs/{tissue}/{query_dataset}_radar_plot.pdf"
